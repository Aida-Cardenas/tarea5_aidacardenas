#!/usr/bin/env python3
"""
Programa principal para optimización de funciones usando algoritmos genéticos
...
def obtener_parametros_usuario():
    """
    Solicita al usuario los parámetros del algoritmo genético
    """
...
def introducir_funcion_personalizada(parametros):
    """
    Permite al usuario introducir y optimizar una función personalizada
    """
    ...
    while True:
        ...
        try:
            ...
            if opcion == '1':
                ...
                print("Desarrollado para la Tarea 5: Algoritmo Genético")
                break
